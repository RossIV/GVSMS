...
$SQL = "SELECT * FROM callees WHERE callees.group = '$group'";
$result = mysql_query($SQL);
$num = mysql_num_rows($result);
?>
      <script type="text/javascript">
      ...
      <?php
while ($i < $num) {
        $phonenumber=mysql_result($result,$i,"phonenum");
        $name=mysql_result($result,$i,"name");
...
print "The following message is being sent to Teleyapper Group Number $group<br>\"$message\"\n";
