  ...
  <div id="wrapper">
   ...
   <form id="mainform" method="post" action="sms.php">
          <table border="0" cellspacing="0" cellpadding="3" width="600" align="center">
			...
			<option value="<?php echo $row['grp']; ?>">
			<?php echo $row['grp']; ?></option>
			<?php } ?>
			 <option value="all">All Registered Numbers</option>
		    <option value="manual">Manual Entry</option>		 
			</select>Please select a group or manual destination.</p>
	
			<tr id="manual" class="hiddenDiv">
            <th align="left">Manual Number</th>
            <td><input type="text" name="number"><span class="body-text">Enter number with area code, but no +1.</span></td>
          </tr>
		  
          <tr>
            <th align=left valign="middle">Message</th>
            <td><textarea name="message" cols="44" rows="8" wrap="virtual" data-maxsize="640" data-output="charcount"></textarea><br />
			<div id="charcount" style="width:300px;font-weight:bold;text-align:right"></div><br />
			</td>
          </tr>
          <tr align=left>
